...
from .views import upload_product,product_list,edit_product_view,product_detail
...
urlpatterns = [
    ...
    path("inventory/product/edit/<int:id>/",edit_product_view, name= "product_update")
